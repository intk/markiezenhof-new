from haagshistorischmuseum import logger
from haagshistorischmuseum.setuphandlers import content
from haagshistorischmuseum.setuphandlers import users
...
class HiddenProfiles(object):
    def getNonInstallableProfiles(self):
        ...
        return [
            "haagshistorischmuseum:uninstall",
        ]
